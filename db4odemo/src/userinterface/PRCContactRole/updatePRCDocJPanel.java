 ...
 * @author raunak
 */
public class updatePRCDocJPanel extends JPanel {
     ...
     */
    public updatePRCDocJPanel(JPanel userProcessContainer, GODNurse go, CareCenterSystem system) {
        initComponents();
        ...
        txtsex.setText(go.getSex());
        txtpsd.setText(go.getPassword());
        txtstatu.setText(go.getStatu());
...
//    }
    ...
    private void SubmitbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitbtnActionPerformed
        ...
        go.setName(txtname.getText());
        go.setSex(txtsex.getText());
        go.setPassword(txtpsd.getText());
        go.setStatu(txtstatu.getText());
        
        system.getUserAccountDirectory().searchUserAccount(go.getUsrname()).setPassword(txtpsd.getText());
