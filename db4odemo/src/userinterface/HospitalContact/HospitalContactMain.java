 ...
 * @author raunak
 */
public class HospitalContactMain extends JPanel {
     ...
     */
    public HospitalContactMain(JPanel userProcessContainer, UserAccount userAccount,CareCenterSystem system) {
        initComponents();
...
//        }
    ...
    private void initComponents() {
        ...
        enterpriseLabel.setText("Hospital Contact:");
    ...
    private void ProcessRequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ProcessRequestActionPerformed
        ...
        ProcessRequestJPanel request=new ProcessRequestJPanel(userProcessContainer,userAccount,system);
    ...
    private void ProcessOutbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ProcessOutbtnActionPerformed
        ...
        // TODO add your handling code here:
        ProcessOutJPanel request=new ProcessOutJPanel(userProcessContainer,userAccount,system);
        CardLayout crdLyt = (CardLayout) userProcessContainer.getLayout();
        userProcessContainer.add(request);
        crdLyt.next(userProcessContainer);
...
//        JOptionPane.showMessageDialog(this,"Out Succesfully!");
    ...
    private void ManageDoctorbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ManageDoctorbtnActionPerformed
        // TODO add your handling code here:
        ManageDoctorJPanel request=new ManageDoctorJPanel(userProcessContainer,userAccount,system);
        CardLayout crdLyt = (CardLayout) userProcessContainer.getLayout();
        userProcessContainer.add(request);
        crdLyt.next(userProcessContainer);
