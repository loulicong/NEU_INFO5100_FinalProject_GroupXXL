 ...
 * @author raunak
 */
public class ProcessRequestJPanel extends JPanel {
     ...
     */
    public ProcessRequestJPanel(JPanel userProcessContainer, UserAccount userAccount, CareCenterSystem system) {
        initComponents();
        this.userProcessContainer = userProcessContainer;
        this.userAccount=userAccount;
        this.hospitalcontact = system.getHospitalContactDirectory().searchContact(userAccount.getUsername());
        this.system = system;
    ...
    private void initComponents() {
        ...
        choosePED.setText("Choose PED Doctor");
        ...
        chooseGO.setText("Choose GO Doctor");
        ...
        if (GOJTable.getColumnModel().getColumnCount() > 0) {
            GOJTable.getColumnModel().getColumn(1).setResizable(false);
        }
    ...
    private void choosePEDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_choosePEDActionPerformed
        ...
        jLabel2.setText(PEDdocList.getPEDocList().get(selectedRow).getName());
    ...
    private void chooseGOActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chooseGOActionPerformed
        ...
        jLabel1.setText(GOdocList.getGODocList().get(selectedRow).getName());
