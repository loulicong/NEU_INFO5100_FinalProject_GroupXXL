 ...
 * @author raunak
 */
public class updatePEDJPanel extends JPanel {
     ...
     */
    public updatePEDJPanel(JPanel userProcessContainer, PEDoc ped, CareCenterSystem system) {
        initComponents();
        ...
        txtname.setText(ped.getName());
        txtsex.setText(ped.getSex());
        txtpsd.setText(ped.getPassword());
        txtstatu.setText(ped.getStatu());
...
//    }
    ...
    private void SubmitbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitbtnActionPerformed
        ...
        ped.setName(txtname.getText());
        ped.setSex(txtsex.getText());
        ped.setPassword(txtpsd.getText());
        ped.setStatu(txtstatu.getText());
        
        system.getUserAccountDirectory().searchUserAccount(ped.getUsrname()).setPassword(txtpsd.getText());
