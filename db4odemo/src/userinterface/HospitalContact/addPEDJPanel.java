 ...
 * @author raunak
 */
public class addPEDJPanel extends JPanel {
     ...
     */
    public addPEDJPanel(JPanel userProcessContainer, CareCenterSystem system) {
        initComponents();
    ...
    private void SubmitbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitbtnActionPerformed
        ...
        PEDoc go=system.getPEdocDirectory().createEmployee(txtname.getText(), txtusername.getText(), txtsex.getText(), hospital);
        Role r=new PedDocRole();
        system.getUserAccountDirectory().createUserAccount(txtusername.getText(), txtpsd.getText(),r);
        hospital.getHospital_PED().addPED(go);
