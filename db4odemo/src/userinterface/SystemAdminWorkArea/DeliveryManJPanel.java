...
import Business.GODoc.GODoc;
import Business.EcoSystem;
import Business.PEDoc.PEDoc;
import Business.Role.GODoctorRole;
 ...
 * @author raunak
 */
public class DeliveryManJPanel extends JPanel {
     ...
     */
    public DeliveryManJPanel(JPanel userProcessContainer,  EcoSystem business) {
        initComponents();
    ...
    public void populateTable(){
        ...
        model.setRowCount(0);
        for(GODoc s:business.getDeliveryManDirectory().getDeliveryManArrayList()){
    ...
    private void addJButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        business.getDeliveryManDirectory().createDeliverMan(userName);
        usernameTextfield.setText("");
    ...
    private void deleteJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_assignJButtonActionPerformed
        ...
        GODoc s = business.getDeliveryManDirectory().getDeliveryManArrayList().get(selectedRow);
        ...
        business.getDeliveryManDirectory().getDeliveryManArrayList().remove(selectedRow);
        ...
        for(int i = 0; i<model.getRowCount(); i++) {
            for (int j = 0; j < model.getColumnCount(); j++) {
                if (j == 1) {
                    ...
                    GODoc s = business.getDeliveryManDirectory().getDeliveryManArrayList().get(i);
                    for (UserAccount v : business.getUserAccountDirectory().getUserAccountList()) {
                        if (s.getName().equals(v.getUsername())) {
                            v.setUsername(temp_name);
                        }
                    }
                    business.getDeliveryManDirectory().getDeliveryManArrayList().get(i).setName(temp_name);
